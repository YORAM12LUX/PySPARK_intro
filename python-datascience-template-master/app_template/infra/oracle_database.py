...
class OracleDatabase(AppConfig):
    ...
    def __init__(self, dialect="jdbc", spark_session=None):
        ...
        self.db_uri = _create_db_uri(self.brcdb_config, dialect)
...
def _create_db_uri(db_config, dialect=None):
